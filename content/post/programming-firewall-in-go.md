...
Tailscale开发了一个应用WFP的库[`inet.af/wf`](https://pkg.go.dev/inet.af/wf) 。参考参考链接。在tailscale中的封装代码如下([源链接](https://github.com/tailscale/tailscale/blob/main/wf/firewall.go))：
