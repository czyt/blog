...
![img](https://assets.czyt.tech/img/api-architecture-styles.png)
...
![img](https://assets.czyt.tech/img/graphQL.jpg)
...
![img](https://assets.czyt.tech/img/grpc.jpg)
...
![img](https://assets.czyt.tech/img/webhook.jpeg)
...
![img](https://assets.czyt.tech/img/api-performance.jpg)
...
![img](https://assets.czyt.tech/img/http3.jpg)
...
![img](https://assets.czyt.tech/img/SOAP%20vs%20REST%20vs%20GraphQL%20vs%20RPC.jpeg)

### 代码优先与应用程序接口优先

下图显示了代码优先开发和 API 优先开发之间的区别。为什么要考虑 API 优先设计？

![img](https://assets.czyt.tech/img/api_first.jpg)
...
![img](https://assets.czyt.tech/img/http-status-code.jpg)
...
![img](https://assets.czyt.tech/img/api_gateway.jpg)
...
![img](https://assets.czyt.tech/img/safe-apis.jpg)
...
![img](https://assets.czyt.tech/img/osi%20model.jpeg)
...
![img](https://assets.czyt.tech/img/Forward%20Proxy%20v.s.%20Reverse%20Proxy2x.jpg)
...
![img](https://assets.czyt.tech/img/lb-algorithms.jpg)
...
![img](https://assets.czyt.tech/img/url-uri-urn.jpg)
...
![img](https://assets.czyt.tech/img/ci-cd-pipeline.jpg)
...
![img](https://assets.czyt.tech/img/netflix-ci-cd.jpg)
...
![img](https://assets.czyt.tech/img/client%20arch%20patterns.png)
...
![img](https://assets.czyt.tech/img/18-oo-patterns.png)
...
![img](https://assets.czyt.tech/img/cloud-dbs2.png)
...
![img](https://assets.czyt.tech/img/8-ds-db.jpg)
...
![img](https://assets.czyt.tech/img/sql%20execution%20order%20in%20db.jpeg)
...
![img](https://assets.czyt.tech/img/cap%20theorem.jpeg)
...
![img](https://assets.czyt.tech/img/Types_of_Memory_and_Storage.jpeg)

### 可视化 SQL 查询

![img](https://assets.czyt.tech/img/sql-execution-order.jpg)
...
![img](https://assets.czyt.tech/img/how-to-learn-sql.jpg)
...
![img](https://assets.czyt.tech/img/where%20do%20we%20cache%20data.jpeg)
...
![img](https://assets.czyt.tech/img/why_redis_fast.jpeg)
...
![img](https://assets.czyt.tech/img/top-redis-use-cases.jpg)
...
![img](https://assets.czyt.tech/img/top_caching_strategy.jpeg)

## 微服务架构

### 典型的微服务架构是什么样的？

![img](https://assets.czyt.tech/img/typical-microservice-arch.jpg)
...
![img](https://assets.czyt.tech/img/microservice-best-practices.jpeg)
...
![img](https://assets.czyt.tech/img/microservice-tech.jpeg)
...
![img](https://assets.czyt.tech/img/why_is_kafka_fast.jpeg)
...
![img](https://assets.czyt.tech/img/learn-payments.jpg)

### 为什么信用卡被称为 "银行最赚钱的产品"？VISA/Mastercard 如何赚钱？

下图显示了信用卡支付流程的经济学原理。

![img](https://assets.czyt.tech/img/how%20does%20visa%20makes%20money.jpg)
...
![img](https://assets.czyt.tech/img/visa_payment.jpeg)
...
![img](https://assets.czyt.tech/img/how-does-upi-work.png)
...
![img](https://assets.czyt.tech/img/devops-sre-platform.jpg)
...
![img](https://assets.czyt.tech/img/k8s.jpeg)
...
![img](https://assets.czyt.tech/img/docker-vs-k8s.jpg)
什么是 Docker？
...
![img](https://assets.czyt.tech/img/docker.jpg)
...
![img](https://assets.czyt.tech/img/git-commands.png)
...
![img](https://assets.czyt.tech/img/git-workflow.jpeg)
...
![img](https://assets.czyt.tech/img/git-merge-git-rebase.jpeg)
...
![img](https://assets.czyt.tech/img/cloud-compare.jpg)

### 什么是云原生？

下图显示了自 20 世纪 80 年代以来架构和流程的演变。

![img](https://assets.czyt.tech/img/cloud-native.jpeg)
...
![img](https://assets.czyt.tech/img/json-cracker.jpeg)

### 自动将代码转化为架构图
![img](https://assets.czyt.tech/img/diagrams_as_code.jpeg)
...
![img](https://assets.czyt.tech/img/linux-file-systems.jpg)
...
![img](https://assets.czyt.tech/img/18%20Most-Used%20Linux%20Commands%20You%20Should%20Know-01.jpeg)
...
![img](https://assets.czyt.tech/img/https.jpg)
...
![img](https://assets.czyt.tech/img/oAuth2.jpg)
...
![img](https://assets.czyt.tech/img/top4-most-used-auth.jpg)
...
![img](https://assets.czyt.tech/img/session.jpeg)
...
![img](https://assets.czyt.tech/img/salt.jpg)
...
![img](https://assets.czyt.tech/img/jwt.jpg)
...
![img](https://assets.czyt.tech/img/google_authenticate.jpeg)
...
![img](https://assets.czyt.tech/img/netflix%20tech%20stack.png)
...
![img](https://assets.czyt.tech/img/twitter-arch.jpeg)

### Airbnb 微服务架构在过去 15 年中的演变

Airbnb 的微服务架构主要经历了三个阶段。

![img](https://assets.czyt.tech/img/airbnb_arch.jpeg)
...
![img](https://assets.czyt.tech/img/monorepo-microrepo.jpg)
...
![img](https://assets.czyt.tech/img/stackoverflow.jpg)
...
![img](https://assets.czyt.tech/img/serverless-to-monolithic.jpeg)
...
![img](https://assets.czyt.tech/img/hotstar_emojis.jpeg)
...
![img](https://assets.czyt.tech/img/discord-store-messages.jpg)
...
![img](https://assets.czyt.tech/img/live_streaming_updated.jpg)
